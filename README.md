...
![first-look](.imgs/first-look.png)

### Добавление новой записи
![new-post](.imgs/new-post.png)

### Новая запись добавлена
Кто-то поставил на неё лайк и написал приветствие
![after-adding-new-post](.imgs/after-adding-new-post.png)

### Редактирование записи
Пользовательница решила написать что рада видеть человека, поприветствовавшего её
![editing](.imgs/editing.png)

### После редактирования
![after-editing](.imgs/after-editing.png)

### Удаление
Пользовательница написала плохие слова и получила хейт в свой адрес
![adding-some-bad-words](.imgs/adding-some-bad-words.png)

### После удаления
К счастью, есть опция удаления своих записей!
